...
public class MainActivity extends AppCompatActivity {
    ...
    int[] ints = new int[]{R.drawable.traffic_01,R.drawable.traffic_02,R.drawable.traffic_03,R.drawable.traffic_04,R.drawable.traffic_05,
            ...
            R.drawable.traffic_12,R.drawable.traffic_13,R.drawable.traffic_14,R.drawable.traffic_15,R.drawable.traffic_16,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get ค่าข้อมูลจากดาต้าเบส
        titleStrings = getResources().getStringArray(R.array.title);
        detailStrings = getResources().getStringArray(R.array.detail);

        // substring detail  ตัดคำเหลือ 20 char
